...
if("Beekey".equals(test)) {
    ...
    beekeyInfo.add("Building Name: Beekey");
    ...
    clinical.add("Department Name: Clinical Experience & Outreach");
    ...
    elmEdu.add("Department Name: Elementary Education");
    ...
    secEdu.add("Department Name: Secondary Education");
    ...
    specEdu.add("Department Name: Special Education");
...
if("Boehm".equals(test)) {
    ...
    phySci.add("Department Name: Physical Sciences");
    ...
    listDataChild.put(listDataHeader.get(2), phySci);
       ...
       if("deFrancesco".equals(test)) {
           ...
           deFranInfo.add("Building Name: deFrancesco");
           deFranInfo.add("AKA: deFran");
           deFranInfo.add("Location: North Side");
           deFranInfo.add("Description:");
           //Adding child data
           List<String> business = new ArrayList<>();
           business.add("Department Name: Business Administration");
           ...
           mls.add("Department Name: Modern Language Studies");
...
if("Grim".equals(test)) {
    ...
    grimInfo.add("Building Name: Grim");
...
if("Lytle".equals(test)) {
    ...
    math.add("Department Name: Mathematics");
    ...
    eng.add("Department Name: English");
...
if("Rickenbach".equals(test)) {
    ...
    elect.add("Department Name: Electronic Media");
...
if("Sharadin".equals(test)) {
    ...
    cd.add("Department Name: Communication Design");
    ...
    far.add("Department Name: Fine Arts");
...
if("Old Main".equals(test)) {
    ...
    cons.add("Department Name: Counseling & Student Affairs");
    ...
    music.add("Department Name: Music");
    ...
    soc.add("Department Name: Anthropology & Sociology");
    ...
    comps.add("Department Name: Computer Science & Information Technology");
    ...
    crj.add("Department Name: Criminal Justice");
    ...
    phi.add("Department Name: Philosophy");
    ...
    ps.add("Department Name: Political Science");
    ...
    psy.add("Department Name: Psychology");
    ...
    sw.add("Department Name: Social Work");
...
//SUB
    ...
    subInfo.add("Building Name: McFarland Student Union Building");
    subInfo.add("AKA: SUB");
...
//AF
     ...
     afInfo.add("Building Name: Academic Forum");
     afInfo.add("AKA: AF");
...
//Auditorium
     ...
     sInfo.add("Building Name: Schaeffer Auditorium");
